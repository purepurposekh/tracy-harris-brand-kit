...
<body data-brand="tracy">
  ...
  <script>
    ...
    // Re-runs on resize and when app-sidebar collapses.
    ...
    // Call initially and after any layout shift (sidebar collapse triggers ~220ms transition)
    positionCategorySidebar();
